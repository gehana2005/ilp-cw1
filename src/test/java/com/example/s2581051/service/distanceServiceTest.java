...
public class distanceServiceTest {
    ...
    void testDistanceWithLargeCoordinates() {
        ...
        assertFalse(violations1.isEmpty(), "Should return an error for coordinates out of bound");
        assertFalse(violations2.isEmpty(),"Should return an error for coordinates out of bound");
    }
    ...
    void testEuclideanDistanceWithSamePoints() {
        ...
        assertEquals(0.0, result, "Distance between identical points must be zero");
    }
    ...
    void testDistanceMixedCoordinates() {
        ...
        double result = service.euclideanDistance(p1, p2);
        double expected = Math.sqrt(36 + 64);
